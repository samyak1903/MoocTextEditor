...
public class MyLinkedListTester {
	...
	public void testRemove()
	{
		...
		for(int i=0;i<LONG_LIST_LENGTH;i++)
		{
			...
			assertEquals("Remoce:check size is correct",LONG_LIST_LENGTH-i-1,longerList.size());
		}
	}
	...
	public void testAddEnd()
	{
		...
		boolean status=emptyList.add(0);
		assertEquals("AddEnd:check state is correct",true,status);
